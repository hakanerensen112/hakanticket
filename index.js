...
client.on('ready', async () => {
  ...
  console.log(`Made by JokeR Hakan`)
  console.log(` Joker | Hakan | `)
  console.log(`Join Bot`)
  client.user.setActivity(`${client.guilds.cache.size} Servers Currently Use This Bot`)
});
